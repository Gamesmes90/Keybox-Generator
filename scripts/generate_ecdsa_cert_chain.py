...
# Variables
ROOT_CA_KEY = "ECDSA_rootCA.key" # Given
ROOT_CA_CERT = "ECDSA_rootCA.pem"

# Intermediate CA A
INTERMEDIATE_CA_KEY_A = "ECDSA_intermediateCA_A.key"
INTERMEDIATE_CA_CSR_A = "ECDSA_intermediateCA_A.csr"
INTERMEDIATE_CA_CERT_A = "ECDSA_intermediateCA_A.pem"

# Intermediate CA B
INTERMEDIATE_CA_KEY_B = "ECDSA_intermediateCA_B.key"
INTERMEDIATE_CA_CSR_B = "ECDSA_intermediateCA_B.csr"
INTERMEDIATE_CA_CERT_B = "ECDSA_intermediateCA_B.pem"

# Server Certificate
SERVER_KEY = "ECDSA_server.key"
SERVER_CSR = "ECDSA_server.csr"
SERVER_CERT = "ECDSA_server.crt"

CERT_CHAIN = "ECDSA_certificate_chain.crt"
...
run_command(f"openssl ecparam -genkey -name secp256r1 -out {INTERMEDIATE_CA_KEY_A}")
...
run_command(f"openssl ecparam -genkey -name secp256r1 -out {INTERMEDIATE_CA_KEY_B}")
...
run_command(f"openssl ecparam -genkey -name secp256r1 -out {SERVER_KEY}")
